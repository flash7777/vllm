...
class FusedMoEQuantConfig:
    ...
    def use_int4_w4a16(self) -> bool:
        # Also covers INT2/INT3 (same Triton kernel path, w_bit_width differs)
        return self._a1.dtype is None and self._w1.dtype in ("int2", "int3", "int4")

    @property
    def w_bit_width(self) -> int:
        """Weight bit width: 2 for INT2, 3 for INT3, 4 for INT4."""
        _map = {"int2": 2, "int3": 3, "int4": 4}
        return _map.get(self._w1.dtype, 4)
