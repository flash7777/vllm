...
class FusedMoE(PluggableLayer):
    ...
    def __init__(
        ...
        # MultiQuant RIY: extract layer index, register, optionally prune.
        import re
        ...
        # MultiQuant RIY: wire prune mask + monitor stats on router.
...
# v0.20.1 compat: re-export classmethod as module-level function
def fused_moe_make_expert_params_mapping(
    model: torch.nn.Module,
    ckpt_gate_proj_name: str,
    ckpt_down_proj_name: str,
