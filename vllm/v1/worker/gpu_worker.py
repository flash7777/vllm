...
class Worker(WorkerBase):
    ...
    def shutdown(self) -> None:
        ...
        # Upstream cleanup: release GPU resources held by the model runner.
        if model_runner := getattr(self, "model_runner", None):
            model_runner.shutdown()
        # MultiQuant cleanup hook: param shrink, dynamo reset, cudaDeviceReset.
        # Extracted to vllm/multiquant/worker_hooks.py to minimize the patch
        # surface across vLLM upgrades (was 159 LOC inline).
        from vllm.multiquant.worker_hooks import release_model_and_caches
        release_model_and_caches(self)
