...
class Worker(WorkerBase):
    ...
    def shutdown(self) -> None:
        ...
        # MultiQuant cleanup hook: drop model+KV caches, reset dynamo,
        # cudaDeviceReset. Extracted to vllm/multiquant/worker_hooks.py to
        # minimize the patch surface across vLLM upgrades (was 159 LOC inline).
